...
function HomePage() {
  ...
  return (
    <div className="container mt-4">
      ...
      <div
        className="p-5 rounded mb-5 text-center text-white"
        style={{
          background: "linear-gradient(135deg, #1f1c2c, #928dab)",
        }}
      >
        <h1 className="fw-bold display-5">Welcome to TechKart</h1>
        <p className="lead">
          Discover the Latest Tech, Gaming Accessories & Premium Gadgets
        </p>
      </div>
      ...
      {categories.map(category => (
        <div key={category} className="mb-5">
          ...
          <h3
            className="mb-4 fw-bold border-start border-4 ps-3"
